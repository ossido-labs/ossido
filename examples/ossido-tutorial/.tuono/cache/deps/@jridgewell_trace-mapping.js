import {
  r as __toESM,
  t as __commonJSMin,
} from './rolldown-runtime-B-1-B7_t.js';
...
var import_resolve_uri_umd = /* @__PURE__ */ __toESM(
...
function resolver(mapUrl, sourceRoot) {
  ...
  return (source) =>
    (0, import_resolve_uri_umd.default)(prefix + (source || ''), from);
}
var COLUMN = 0;
var SOURCES_INDEX = 1;
var SOURCE_LINE = 2;
...
function traceSegmentInternal(segments, memo, line, column, bias) {
  ...
  if (found)
    index = (bias === -1 ? upperBound : lowerBound)(segments, column, index);
...
function generatedPosition(map, source, line, column, bias, all) {
  ...
  const segments = ((_b = cast(map))._bySources ||
