...
const routes = [
  {
    ...
    fullPath:
      '/ossido/packages/ossido-fs-router-vite-plugin/tests/generator/multi-level-root/routes/posts/[post].tsx',
  ...
  },
  {
    ...
    fullPath:
      '/ossido/packages/ossido-fs-router-vite-plugin/tests/generator/multi-level-root/routes/posts/__layout.tsx',
  ...
  },
  {
    filePath: 'index.tsx',
    fullPath:
      '/ossido/packages/ossido-fs-router-vite-plugin/tests/generator/multi-level-root/routes/index.tsx',
    routePath: '/',
    variableName: 'Index',
    path: '/',
    cleanedPath: '/',
  },
  {
    ...
    fullPath:
      '/ossido/packages/ossido-fs-router-vite-plugin/tests/generator/multi-level-root/routes/posts/my-post.tsx',
