...
describe('normalizeConfig', () => {
  ...
  describe('viewTransitions', () => {
    it('should default viewTransitions to false', () => {
      expect(normalizeConfig({})).toStrictEqual(
        expect.objectContaining({ viewTransitions: false }),
      );
    });

    it('should honour viewTransitions set to true', () => {
      const config: OssidoConfig = { viewTransitions: true };
