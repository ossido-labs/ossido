...
//#endregion
//#region ../../../node_modules/.bun/@jridgewell+trace-mapping@0.3.31/node_modules/@jridgewell/trace-mapping/dist/trace-mapping.mjs
...
function traceSegment(map, line, column) {
	...
	const index = traceSegmentInternal(segments, cast(map)._decodedMemo, line, column, 1);
...
function generatedPositionFor(map, needle) {
	...
	return generatedPosition(map, source, line, column, bias || 1, false);
}
function allGeneratedPositionsFor(map, needle) {
	const { source, line, column, bias } = needle;
	return generatedPosition(map, source, line, column, bias || -1, true);
}
...
function sliceGeneratedPositions(segments, memo, line, column, bias) {
	let min = traceSegmentInternal(segments, memo, line, column, 1);
	if (!found && bias === -1) min++;
...
//#endregion
export { FlattenMap as AnyMap, FlattenMap, GREATEST_LOWER_BOUND, LEAST_UPPER_BOUND, TraceMap, allGeneratedPositionsFor, decodedMap, decodedMappings, eachMapping, encodedMap, encodedMappings, generatedPositionFor, isIgnored, originalPositionFor, presortedDecodedMap, sourceContentFor, traceSegment };
