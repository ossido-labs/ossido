(function(exports) {
	...
	*/
	...
	function RouterContextProvider({ router, serverInitialLocation, children }) {
		const [location, setLocation] = (0, import_react$14.useState)(() => getInitialLocation(serverInitialLocation));
		const [navigationId, setNavigationId] = (0, import_react$14.useState)(0);
		const updateLocation = (0, import_react$14.useCallback)((newLocation, options = {}) => {
			const commit = () => {
	...
	*/
	...
	var import_react$14, import_jsx_runtime$29, isServerSide, FALLBACK_DELAY_MS, wait, CRITICAL_CSS_PATH$1, CRITICAL_CSS_LINK_SELECTOR, RouterContext;
	...
	var init_useRouter = __esmMin((() => {
		...
		useRouter = () => {
			...
			const navigate = (0, import_react$13.useCallback)((type, path, opts) => {
			...
			return {
				push: (0, import_react$13.useCallback)((path, opts) => {
					navigate("pushState", path, opts);
				}, [navigate]),
				replace: (0, import_react$13.useCallback)((path, opts) => {
	...
	*/
	...
	var import_react$11, import_react$12, observerMap, RootIds, rootId, unsupportedValue;
	...
	*/
	function RouteDataLoader({ route, resourceKey, location }) {
		const result = (0, import_react$9.use)(getOrCreateResource(resourceKey, route, location));
...
`;
	...
	*/
	...
	var import_react$4, import_jsx_runtime$17, RouteMatch, TraverseRootComponents, loadParentComponents;
	var init_RouteMatch = __esmMin((() => {
		...
		RouteMatch = ({ route, mode }) => {
			...
			const routes = (0, import_react$4.useMemo)(() => loadParentComponents(route), [route.id]);
			...
			return /* @__PURE__ */ (0, import_jsx_runtime$17.jsxs)(TraverseRootComponents, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime$17.jsx)(CriticalCss, {
					...
					mode
				}), /* @__PURE__ */ (0, import_jsx_runtime$17.jsx)(import_react$4.Suspense, {
		...
		TraverseRootComponents = (0, import_react$4.memo)(({ routes, index = 0, mode, children }) => {
	...
	*/
	...
	function TuonoEntryPoint({ router, serverPayload, rawServerPayload }) {
		return /* @__PURE__ */ (0, import_jsx_runtime$11.jsx)(import_react$2.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime$11.jsx)(TuonoContextProvider, {
			serverPayload,
			rawServerPayload,
	...
	*/
	...
	var init_RouteLazyLoading = __esmMin((() => {
		...
		RouteLazyLoading = (factory) => {
			...
			const Component = (props) => (0, import_react$1.createElement)(LoadedComponent || LazyComponent, props);
	...
	*/
	...
	function RootLayout({ children }) {
		return /* @__PURE__ */ (0, import_jsx_runtime$6.jsx)("html", { children: /* @__PURE__ */ (0, import_jsx_runtime$6.jsxs)("body", { children: [/* @__PURE__ */ (0, import_jsx_runtime$6.jsx)("main", { children }), /* @__PURE__ */ (0, import_jsx_runtime$6.jsx)(TuonoScripts, {})] }) });
	}
	//#endregion
	//#region src/routes/page.tsx
	var page_exports$5 = /* @__PURE__ */ __exportAll({ default: () => IndexPage });
	function IndexPage({ subtitle }) {
		return /* @__PURE__ */ (0, import_jsx_runtime$5.jsxs)(import_jsx_runtime$5.Fragment, { children: [
			/* @__PURE__ */ (0, import_jsx_runtime$5.jsx)("h1", { children: "TUONO" }),
			/* @__PURE__ */ (0, import_jsx_runtime$5.jsx)("h2", { children: subtitle }),
			/* @__PURE__ */ (0, import_jsx_runtime$5.jsxs)("nav", { children: [
	...
	var page_exports$4 = /* @__PURE__ */ __exportAll({ default: () => ThrowsPage$1 });
	/**
	...
	*/
	...
	function ThrowsPage$1() {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime$4.jsxs)("div", { children: [
			/* @__PURE__ */ (0, import_jsx_runtime$4.jsx)("h1", { children: "Throws" }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime$4.jsx)("button", {
				...
				onClick: () => {
					Promise.reject(/* @__PURE__ */ new Error("Unhandled promise rejection"));
				},
	...
	var page_exports$3 = /* @__PURE__ */ __exportAll({ default: () => SecondRoute });
	function SecondRoute() {
		return /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("h1", { children: "Second route" });
	}
	...
	var page_exports$2 = /* @__PURE__ */ __exportAll({ default: () => RustErrorPage$1 });
	/**
	...
	*/
	function RustErrorPage$1() {
		return /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("h1", { children: "Rust error route" });
	}
	...
	var page_exports$1 = /* @__PURE__ */ __exportAll({ default: () => PokemonPage });
	function PokemonPage({ name }) {
		return /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("h1", { children: ["Pokemon: ", name] });
	}
	...
	function DocPage({ slug }) {
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", { children: ["Doc: ", slug] });
	}
	...
	init_esm();
	var PageImport = RouteLazyLoading(() => Promise.resolve().then(() => (init_page$5(), page_exports$5)));
	var ThrowsPageImport = RouteLazyLoading(() => Promise.resolve().then(() => (init_page$4(), page_exports$4)));
	var SecondRoutePageImport = RouteLazyLoading(() => Promise.resolve().then(() => (init_page$3(), page_exports$3)));
	var RustErrorPageImport = RouteLazyLoading(() => Promise.resolve().then(() => (init_page$2(), page_exports$2)));
	var PokemonspokemonPageImport = RouteLazyLoading(() => Promise.resolve().then(() => (init_page$1(), page_exports$1)));
	var DocsslugPageImport = RouteLazyLoading(() => Promise.resolve().then(() => (init_page(), page_exports)));
