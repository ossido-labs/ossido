(function (exports) {
  ...
  function TuonoContextProvider({ serverPayload, rawServerPayload, children }) {
    const contextValue = (0, import_react$15.useMemo)(() => {
      return {
        serverPayload: isServerSide$2
          ? serverPayload
          : window[SERVER_PAYLOAD_VARIABLE_NAME],
        rawServerPayload,
      };
  ...
  function useTuonoContextServerPayload() {
    return (0, import_react$15.useContext)(TuonoContext).serverPayload;
  }
  /**
   * @warning THIS SHOULD NOT BE EXPOSED TO USERLAND
   *
  ...
  function useTuonoContextRawServerPayload() {
    return (0, import_react$15.useContext)(TuonoContext).rawServerPayload;
  }
  var import_react$15, import_jsx_runtime$30, isServerSide$2, TuonoContext;
  var init_TuonoContext = __esmMin(() => {
    ...
    TuonoContext = (0, import_react$15.createContext)({});
  });
  //#endregion
  ...
  function getOrCreateResource(key, route, location) {
    ...
    if (isServerSide$1 || !route.options.hasHandler)
      return seedResource(key, {
        kind: 'data',
        props: {},
      });
  ...
  function RouterContextProvider({ router, serverInitialLocation, children }) {
    const [location, setLocation] = (0, import_react$14.useState)(() =>
      getInitialLocation(serverInitialLocation),
    );
    const [navigationId, setNavigationId] = (0, import_react$14.useState)(0);
    const updateLocation = (0, import_react$14.useCallback)(
      (newLocation, options = {}) => {
        const commit = () => {
        ...
        for (
          let node = targetRoute;
          node;
          node = node.isRoot ? void 0 : node.options.getParentRoute?.()
        ) {
    ...
    const retry = (0, import_react$14.useCallback)(() => {
      setNavigationId((id) => id + 1);
    }, []);
    /**
    ...
    const contextValue = (0, import_react$14.useMemo)(
      () => ({
        router,
        location,
        navigationId,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime$29.jsx)(
  ...
  function useRouterContext() {
    return (0, import_react$14.useContext)(RouterContext);
  }
  var import_react$14,
  ...
  var init_RouterContext = __esmMin(() => {
    ...
    RouterContext = (0, import_react$14.createContext)({});
  });
  //#endregion
  //#region ../../../packages/tuono-router/dist/esm/hooks/useRouter.js
  var import_react$13, useRouter;
  var init_useRouter = __esmMin(() => {
    ...
    useRouter = () => {
      ...
      const navigate = (0, import_react$13.useCallback)(
        (type, path, opts) => {
      ...
      return {
        push: (0, import_react$13.useCallback)(
          (path, opts) => {
            navigate('pushState', path, opts);
          },
          [navigate],
        ),
        replace: (0, import_react$13.useCallback)(
          (path, opts) => {
  ...
  function useInView({
    ...
    var _a;
    const [ref, setRef] = import_react$12.useState(null);
    const callback = import_react$12.useRef(onChange);
    const [state, setState] = import_react$12.useState({
    ...
    const previousEntryTarget = import_react$12.useRef(void 0);
    if (
      !ref &&
      entryTarget &&
      !triggerOnce &&
  ...
  function RouteDataLoader({ route, resourceKey, location }) {
    const result = (0, import_react$9.use)(
      getOrCreateResource(resourceKey, route, location),
    );
    if (result.kind === 'redirect')
      return /* @__PURE__ */ (0, import_jsx_runtime$26.jsx)(Redirect, {
        to: result.destination,
      });
    const Component = route.component;
    return /* @__PURE__ */ (0, import_jsx_runtime$26.jsx)(Component, {
      ...result.props,
    });
  }
  var import_react$9, import_jsx_runtime$26;
  ...
  var import_react$8, import_jsx_runtime$25, TuonoErrorBoundary;
  var init_TuonoErrorBoundary = __esmMin(() => {
    ...
    TuonoErrorBoundary = class extends import_react$8.Component {
      constructor(..._args) {
        super(..._args);
        this.state = {
          error: null,
   ...
   */
  function BaseStyles() {
    return /* @__PURE__ */ (0, import_jsx_runtime$24.jsx)('style', {
      children: base_default,
    });
  }
  ...
  function DefaultScreen({ role, badge, title, children }) {
    return /* @__PURE__ */ (0, import_jsx_runtime$23.jsxs)('div', {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime$23.jsx)('style', {
          children: STYLES,
        }),
...
`;
   ...
   * LICENSE file in the root directory of this source tree.
   */
  var require_react_dom_production = /* @__PURE__ */ __commonJSMin(
    (exports) => {
  ...
  var init_RouteMatch = __esmMin(() => {
    ...
    RouteMatch = ({ route, mode }) => {
      ...
      const routes = (0, import_react$4.useMemo)(
        () => loadParentComponents(route),
        [route.id],
      );
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime$17.jsxs)(
        TraverseRootComponents,
        {
          routes,
          mode,
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime$17.jsx)(CriticalCss, {
              routeFilePath: route.filePath,
              mode,
            }),
            /* @__PURE__ */ (0, import_jsx_runtime$17.jsx)(
              import_react$4.Suspense,
              {
                fallback: /* @__PURE__ */ (0, import_jsx_runtime$17.jsx)(
                  LoadingComponent,
                  {},
                ),
                children: /* @__PURE__ */ (0, import_jsx_runtime$17.jsx)(
                  TuonoErrorBoundary,
                  {
    ...
    TraverseRootComponents = (0, import_react$4.memo)(
      ({ routes, index = 0, mode, children }) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime$17.jsx)(
          import_jsx_runtime$17.Fragment,
          { children },
        );
      },
    );
  ...
  function NotFound({ mode }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime$15.jsxs)(RootLayout, {
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)(CriticalCss, {
          routeFilePath: '__root__',
          mode,
        }),
        CustomNotFound
          ? /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)(CustomNotFound, {})
          : /* @__PURE__ */ (0, import_jsx_runtime$15.jsx)(
  ...
  function Matches({ mode }) {
    ...
    if (!route)
      return /* @__PURE__ */ (0, import_jsx_runtime$14.jsx)(NotFound, { mode });
  ...
  function RouterProvider({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime$13.jsxs)(
      RouterContextProvider,
      {
        router,
        serverInitialLocation,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime$13.jsx)(Matches, { mode }),
          false,
        ],
      },
    );
  }
  var import_react$3, import_jsx_runtime$13;
  ...
  function TuonoEntryPoint({ router, serverPayload, rawServerPayload }) {
    return /* @__PURE__ */ (0, import_jsx_runtime$11.jsx)(
      import_react$2.StrictMode,
      {
        children: /* @__PURE__ */ (0, import_jsx_runtime$11.jsx)(
  ...
  var import_react$2, import_jsx_runtime$11;
  ...
  var init_url_search_params_polyfill = __esmMin(() => {
    ...
    (function (self) {
      ...
      var nativeURLSearchParams = (function () {
        ...
        isSupportSize =
          nativeURLSearchParams && 'size' in nativeURLSearchParams.prototype,
        ...
        if (typeof search === 'object') {
          if (isArray(search))
            ...
            for (var key in search)
              if (search.hasOwnProperty(key)) appendTo(dict, key, search[key]);
        } else {
   ...
   * LICENSE file in the root directory of this source tree.
   */
  var require_react_dom_server_legacy_browser_production =
    /* @__PURE__ */ __commonJSMin((exports) => {
      ...
      function escapeTextForBrowser(text) {
        ...
        if (match) {
          ...
          text =
            lastIndex !== index ? html + text.slice(lastIndex, index) : html;
        }
        return text;
      }
      ...
      function getChildFormatContext(parentContext, type, props) {
        ...
        return 6 <= parentContext.insertionMode ||
          2 > parentContext.insertionMode
      ...
      function getSuspenseContentFormatContext(resumableState, parentContext) {
        resumableState = getSuspenseViewTransition(
      ...
      function getCustomFormFields(resumableState, formAction) {
        if ('function' === typeof formAction.$$FORM_ACTION) {
          ...
          try {
            ...
            if (customFields)
              customFields.data?.forEach(validateAdditionalFormField);
            return customFields;
          } catch (x) {
            if (
              'object' === typeof x &&
              ...
              if (null !== resourceState$jscomp$0) {
                ...
                if (resourceState$jscomp$0) {
                  2 === resourceState$jscomp$0.length &&
                    ...
                    adoptPreloadCredentials(
                      scriptProps,
                      resourceState$jscomp$0,
                    ));
          ...
          case 'style':
            ...
            if (
              ...
              'function' !== typeof child &&
                ...
                void 0 !== child &&
                target$jscomp$0.push(
                  ('' + child).replace(styleRegex, styleReplacer),
                );
              pushInnerHTML(
                target$jscomp$0,
                innerHTML$jscomp$5,
            ...
            if (
              ...
              if (resource$jscomp$1) {
                ...
                0 <= (headers.remainingCapacity -= header.length + 2))
                  ? ((renderState.resets.image[key$jscomp$0] =
                      PRELOAD_NO_CREDS),
      ...
      function createRenderState(resumableState, generateStaticMarkup) {
        ...
        var JSCompiler_object_inline_preconnects_1687 =
            /* @__PURE__ */ new Set(),
          JSCompiler_object_inline_fontPreloads_1688 =
            /* @__PURE__ */ new Set(),
          JSCompiler_object_inline_highImagePreloads_1689 =
            /* @__PURE__ */ new Set(),
          ...
          JSCompiler_object_inline_bulkPreloads_1693 =
            /* @__PURE__ */ new Set(),
      ...
      var HooksDispatcher = {
        ...
        useId: function () {
          ...
          0 < overflow &&
            (JSCompiler_inline_result += 'H' + overflow.toString(32));
          ...
          if ('string' === typeof type.name) {
            a: {
              ...
              if (
                ...
                (type =
                  -1 !== type ? (location = location.slice(0, type)) : ''),
      ...
      function renderElement(request, task, keyPath, type, props, ref) {
        if ('function' === typeof type)
          if (type.prototype && type.prototype.isReactComponent) {
            ...
            var initialState =
              void 0 !== newProps.state ? newProps.state : null;
              ...
              case REACT_FORWARD_REF_TYPE:
                if ('ref' in props)
                  for (fallback in ((newProps = {}), props))
                    'ref' !== fallback &&
                      (newProps[fallback] = props[fallback]);
                else newProps = props;
      ...
      function completeShell(request) {
        null === request.trackedPostpones &&
          safelyEmitEarlyPreloads(request, !0);
        ...
        switch (segment.status) {
          ...
          case 1:
            ...
            chunkIdx < chunks.length &&
              (r = destination.push(chunks[chunkIdx]));
            return r;
          case 3:
            return !0;
          default:
      ...
      function flushCompletedQueues(request, destination) {
        try {
          if (!(0 < request.pendingRootTasks)) {
            ...
            renderState$jscomp$1.preconnects.forEach(
              flushResource,
              destination,
            );
            renderState$jscomp$1.preconnects.clear();
            renderState$jscomp$1.fontPreloads.forEach(
              flushResource,
              destination,
            );
            ...
            renderState$jscomp$1.bulkPreloads.forEach(
              flushResource,
              destination,
            );
            ...
            for (i = 0; i < clientRenderedBoundaries.length; i++) {
              ...
              var JSCompiler_inline_result =
                renderState$jscomp$1.push(')<\/script>');
      ...
      function abort(request, reason) {
        ...
        try {
          ...
          (logRecoverableError(request, error$71, {}),
            fatalError(request, error$71));
        }
      }
  ...
  var require_ponyfill = /* @__PURE__ */ __commonJSMin((exports, module) => {
    ...
    (function (e, t) {
      ...
      const R = Symbol('[[AbortSteps]]'),
        T = Symbol('[[ErrorSteps]]'),
        P = Symbol('[[CancelSteps]]'),
        C = Symbol('[[PullSteps]]'),
        q = Symbol('[[CanPullSyncSteps]]'),
        E = Symbol('[[ReleaseSteps]]');
      function W(e, t) {
      ...
      class ReadableStreamDefaultReader {
        constructor(e) {
          if (
            (Y(e, 1, 'ReadableStreamDefaultReader'),
            V(e, 'First parameter'),
            Mr(e))
          )
            throw new TypeError(
        ...
        null !==
          (le =
            null !== (ae = Symbol.asyncIterator) && void 0 !== ae
              ? ae
              : null === (se = Symbol.for) || void 0 === se
                ? void 0
                : se.call(Symbol, 'Symbol.asyncIterator')) && void 0 !== le
          ? le
          : '@@asyncIterator';
      ...
      class ge {
        ...
        _chunkSteps(e) {
          ((this._iterator._ongoingPromise = void 0),
            S(() =>
              this._resolvePromise({
                value: e,
                done: !1,
      ...
      function qe(e, t, r) {
        if ('number' != typeof (o = r) || Te(o) || o < 0 || r === Infinity)
          throw new RangeError(
      ...
      class ReadableStreamBYOBRequest {
        ...
        respondWithNewView(e) {
          ...
          if ((Y(e, 1, 'respondWithNewView'), !ArrayBuffer.isView(e)))
      ...
      class ReadableByteStreamController {
        ...
        enqueue(e) {
          ...
          if ((Y(e, 1, 'enqueue'), !ArrayBuffer.isView(e)))
      ...
      function ke(e) {
        ...
        h(
          ...
          () => (
            (e._pulling = !1),
            e._pullAgain && ((e._pullAgain = !1), ke(e)),
            null
          ),
          (t) => (Je(e, t), null),
        );
      ...
      function $e(e, t) {
        (t.bytesFilled > 0 && Ie(e, t.buffer, t.byteOffset, t.bytesFilled),
          Ve(e));
      }
      function Me(e, t) {
        ...
        for (; n > 0; ) {
          ...
          (ce(t.buffer, i, r.buffer, r.byteOffset, o),
            r.byteLength === o
              ? s.shift()
      ...
      function xe(e) {
        0 === e._queueTotalSize && e._closeRequested
          ? (Ue(e), xr(e._controlledReadableByteStream))
          : ke(e);
      }
      function Qe(e) {
        null !== e._byobRequest &&
      ...
      function He(e, t) {
        ...
        ('closed' === e._controlledReadableByteStream._state
          ...
          : (function (e, t, r) {
              ...
              r.bytesFilled -= o;
              const n = Ne(e);
              (ze(e._controlledReadableByteStream, r),
                De(e._controlledReadableByteStream, n));
            })(e, t, r),
          ke(e));
      }
      function Ve(e) {
          ...
          if (e._queueTotalSize > 0) e._closeRequested = !0;
            ...
            if (e._pendingPullIntos.length > 0) {
              ...
              if (t.bytesFilled % t.elementSize !== 0) {
                const t = /* @__PURE__ */ new TypeError(
      ...
      function Xe(e, t) {
        ...
        if (e._pendingPullIntos.length > 0) {
          ...
          (Qe(e),
            (t.buffer = de(t.buffer)),
            'none' === t.readerType && $e(e, t));
        }
        if (K(r))
          if (
            ((function (e) {
      ...
      class ReadableStreamBYOBReader {
        constructor(e) {
          if (
            (Y(e, 1, 'ReadableStreamBYOBReader'),
            V(e, 'First parameter'),
            Mr(e))
          )
            throw new TypeError(
          ...
          if (!Oe(e._readableStreamController))
            throw new TypeError(
        ...
        read(e, t = {}) {
          ...
          if (fe(e.buffer))
            return f(
              /* @__PURE__ */ new TypeError("view's buffer has been detached"),
            );
          let r;
          try {
            r = (function (e, t) {
            ...
            return (
              ...
              (function (e, t, r) {
                ...
                return (
                  ...
                  ('closed' === o._state || e._queueTotalSize >= a)
                );
        ...
        ((n._disturbed = !0),
          'errored' === n._state
            ...
            : (function (e, t, r, o) {
                ...
                if (e._pendingPullIntos.length > 0)
                  return (e._pendingPullIntos.push(d), void lt(n, o));
                if ('closed' === n._state) {
            ...
            o = (function (e, t) {
              ...
              return {
                abort:
                  void 0 === r
                    ? void 0
                    : vt(r, e, `${t} has member 'abort' that`),
                close:
                  void 0 === o
                    ? void 0
                    : wt(o, e, `${t} has member 'close' that`),
                start:
                  void 0 === n
                    ? void 0
                    : Rt(n, e, `${t} has member 'start' that`),
                write:
                  void 0 === a
                    ? void 0
                    : Tt(a, e, `${t} has member 'write' that`),
                type: i,
              };
            })(e, 'First parameter');
          qt(this);
      ...
      function Ot(e) {
        ...
        var n;
        return (
          void 0 !== o && e._backpressure && 'writable' === t && dr(o),
          qe((n = e._writableStreamController), Qt, 0),
          Gt(n),
          r
        );
      }
      ...
      function At(e) {
        ...
        if (((e._pendingAbortRequest = void 0), r._wasAlreadyErroring))
          return (r._reject(t), void Dt(e));
        h(
          e._writableStreamController[R](r._reason),
          () => (r._resolve(), Dt(e), null),
          (t) => (r._reject(t), Dt(e), null),
        );
      }
      function zt(e) {
      ...
      class WritableStreamDefaultWriter {
        constructor(e) {
          if (
            (Y(e, 1, 'WritableStreamDefaultWriter'),
          ...
          const t = e._state;
          if ('writable' === t)
            (!zt(e) && e._backpressure ? sr(this) : ur(this), or(this));
      ...
      function Ht(e, t, r, o, n, i, a, s) {
        ...
        h(
          d(r()),
          () => ((t._started = !0), Gt(t), null),
          (r) => ((t._started = !0), jt(e, r), null),
        );
      }
      function Vt(e) {
        ...
        return c((m, p) => {
            ...
            if (
              ((S = () => {
                const r =
                    void 0 !== i.reason
                      ? i.reason
                      : new br('Aborted', 'AbortError'),
                  a = [];
                (o ||
                  a.push(() =>
                    'writable' === t._state ? Bt(t, r) : d(void 0),
                  ),
                  n ||
                    a.push(() =>
                      'readable' === e._state ? Yr(e, r) : d(void 0),
                    ),
                  T(() => Promise.all(a.map((e) => e())), !0, r));
              }),
              i.aborted)
            )
              return void S();
          ...
          if (
            (yr(
              e,
              a._closedPromise,
              (e) => (o ? P(!0, e) : T(() => Bt(t, e), !0, e), null),
            ),
            yr(
              t,
              s._closedPromise,
              (t) => (n ? P(!0, t) : T(() => Yr(e, t), !0, t), null),
            ),
            (v = e),
            (w = a._closedPromise),
            (R = () => (
            ...
            'closed' === v._state ? R() : _(w, R),
            zt(t) || 'closed' === t._state)
          ) {
            const t = /* @__PURE__ */ new TypeError(
          ...
          function T(e, r, o) {
            ...
            l._shuttingDown ||
              ((l._shuttingDown = !0),
              'writable' !== t._state || zt(t)
                ? n()
                : _(l._waitForWritesToFinish(), n));
          }
          function P(e, r) {
            l._shuttingDown ||
              ((l._shuttingDown = !0),
              'writable' !== t._state || zt(t)
                ? C(e, r)
                : _(l._waitForWritesToFinish(), () => C(e, r)));
          }
          function C(e, t) {
            return (
              Yt(s),
              O(a),
              void 0 !== i && i.removeEventListener('abort', S),
              e ? p(t) : m(void 0),
              null
            );
          }
      ...
      class _r {
        constructor(e) {
          ((this._writer = e),
            (this._shuttingDown = !1),
            (this._currentWrite = d(void 0)));
        }
        _waitForWritesToFinish() {
          const e = this._currentWrite;
          return b(this._currentWrite, () =>
            e !== this._currentWrite ? this._waitForWritesToFinish() : void 0,
          );
        }
      }
      class mr {
        ...
        _chunkSteps(e) {
          ((this._state._currentWrite = b(
            xt(this._state._writer, e),
            void 0,
            t,
          )),
            this._resolvePromise(!1));
        }
        _closeSteps() {
      ...
      function gr(e) {
        ...
        h(
          ...
          () => (
            (e._pulling = !1),
            e._pullAgain && ((e._pullAgain = !1), gr(e)),
            null
          ),
          (t) => (Pr(e, t), null),
        );
      ...
      function Br(e, t) {
        return Oe(e._readableStreamController)
          ? (function (e) {
              let t,
                r,
                o,
              ...
              function _(e) {
                m(
                  ...
                  (t) => (
                    e !== a ||
                      (Je(o._readableStreamController, t),
                      Je(n._readableStreamController, t),
                      (f && b) || i(void 0)),
                    null
                  ),
                );
                ...
                re(a, {
                  _chunkSteps: (t) => {
                    S(() => {
                      ...
                      (f || Xe(o._readableStreamController, r),
                        b || Xe(n._readableStreamController, a),
                        (s = !1),
                        l ? g() : u && v());
                    });
                  },
                  _closeSteps: () => {
                    ((s = !1),
                      f || Ge(o._readableStreamController),
                      b || Ge(n._readableStreamController),
                      o._readableStreamController._pendingPullIntos.length >
                        0 && tt(o._readableStreamController, 0),
                      n._readableStreamController._pendingPullIntos.length >
                        0 && tt(n._readableStreamController, 0),
                      (f && b) || i(void 0));
                  },
                  _errorSteps: () => {
                    s = !1;
              ...
              function y(t, r) {
                ...
                ht(a, t, 1, {
                    ...
                    S(() => {
                      ...
                      if (r ? f : b) o || rt(c._readableStreamController, t);
                        ...
                        try {
                          ...
                          (Je(c._readableStreamController, t),
                            Je(d._readableStreamController, t),
                            i(Yr(e, t)));
                          return;
                        }
                        (o || rt(c._readableStreamController, t),
                          Xe(d._readableStreamController, r));
                      }
                      ((s = !1), l ? g() : u && v());
                    });
                  },
                  _closeSteps: (e) => {
                    ...
                    const t = r ? b : f,
                      o = r ? f : b;
                    (t || Ge(c._readableStreamController),
                      o || Ge(d._readableStreamController),
                      void 0 !== e &&
                        (t || rt(c._readableStreamController, e),
                        !o &&
                          d._readableStreamController._pendingPullIntos.length >
                            0 &&
                          tt(d._readableStreamController, 0)),
                      (t && o) || i(void 0));
                  },
                  _errorSteps: () => {
                    s = !1;
          ...
          : (function (e) {
                  ...
                  re(t, {
                    _chunkSteps: (e) => {
                      S(() => {
                        ...
                        const t = e,
                          r = e;
                        (u || Tr(n._readableStreamController, t),
                          f || Tr(i._readableStreamController, r),
                          (s = !1),
                          l && h());
                      });
                    },
                    _closeSteps: () => {
                      ((s = !1),
                        u || Rr(n._readableStreamController),
                        f || Rr(i._readableStreamController),
                        (u && f) || a(void 0));
                    },
                    _errorSteps: () => {
                      s = !1;
              ...
              return (
                ...
                m(
                  t._closedPromise,
                  (e) => (
                    Pr(n._readableStreamController, e),
                    Pr(i._readableStreamController, e),
                    (u && f) || a(void 0),
                    null
                  ),
                ),
      ...
      class ReadableStream {
            ...
            o = (function (e, t) {
              ...
              return {
                autoAllocateChunkSize:
                  void 0 === o
                    ? void 0
                    : H(o, `${t} has member 'autoAllocateChunkSize' that`),
                cancel:
                  void 0 === n
                    ? void 0
                    : jr(n, r, `${t} has member 'cancel' that`),
                pull:
                  void 0 === i
                    ? void 0
                    : kr(i, r, `${t} has member 'pull' that`),
                start:
                  void 0 === a
                    ? void 0
                    : Ar(a, r, `${t} has member 'start' that`),
                type:
                  void 0 === s ? void 0 : zr(s, `${t} has member 'type' that`),
              };
            })(e, 'First parameter');
          if ((Ir(this), 'bytes' === o.type)) {
            ...
            (function (e, t, r) {
              ...
              ((n = void 0 !== t.start ? () => t.start(o) : () => {}),
                (i = void 0 !== t.pull ? () => t.pull(o) : () => d(void 0)),
                (a =
                  void 0 !== t.cancel ? (e) => t.cancel(e) : () => d(void 0)));
            ...
            (function (e, t, r, o) {
              ...
              let i, a, s;
              ((i = void 0 !== t.start ? () => t.start(n) : () => {}),
                (a = void 0 !== t.pull ? () => t.pull(n) : () => d(void 0)),
                (s =
                  void 0 !== t.cancel ? (e) => t.cancel(e) : () => d(void 0)),
                Er(e, n, i, a, s, r, o));
            })(this, o, pt(r, 1), e);
        ...
        getReader(e = void 0) {
          ...
          return void 0 ===
            (function (e, t) {
              ...
              return {
                mode:
                  void 0 === r ? void 0 : at(r, `${t} has member 'mode' that`),
              };
        ...
        pipeThrough(e, t = {}) {
          ...
          const r = (function (e, t) {
              ...
              (x(r, 'readable', 'ReadableWritablePair'),
                V(r, `${t} has member 'readable' that`));
              const o = null == e ? void 0 : e.writable;
              return (
                x(o, 'writable', 'ReadableWritablePair'),
      ...
      function Hr(e, t) {
        ...
        const r = null == e ? void 0 : e.highWaterMark;
        return (
          x(r, 'highWaterMark', 'QueuingStrategyInit'), { highWaterMark: Q(r) }
        );
      }
      (Object.defineProperties(ReadableStream, { from: { enumerable: !0 } }),
      ...
      class ByteLengthQueuingStrategy {
        constructor(e) {
          (Y(e, 1, 'ByteLengthQueuingStrategy'),
            (e = Hr(e, 'First parameter')),
      ...
      class TransformStream {
        constructor(e = {}, t = {}, r = {}) {
            ...
            i = (function (e, t) {
              ...
              return {
                cancel:
                  void 0 === r
                    ? void 0
                    : ro(r, e, `${t} has member 'cancel' that`),
                flush:
                  void 0 === o
                    ? void 0
                    : Zr(o, e, `${t} has member 'flush' that`),
                readableType: n,
                start:
                  void 0 === i
                    ? void 0
                    : eo(i, e, `${t} has member 'start' that`),
                transform:
                  void 0 === a
                    ? void 0
                    : to(a, e, `${t} has member 'transform' that`),
                writableType: s,
              };
            })(e, 'First parameter');
          ...
          ((function (e, t, r, o, n, i) {
                ...
                return (
                  ...
                  h(
                    ...
                    () => (
                      'errored' === o._state
                        ? _o(r, o._storedError)
                        : (Pr(o._readableStreamController, t), ho(r)),
                      null
                    ),
                    (e) => (Pr(o._readableStreamController, e), _o(r, e), null),
                  ),
                  r._finishPromise
                );
              })(e, t);
                ...
                return (
                  ...
                  h(
                    ...
                    () => (
                      'errored' === r._state
                        ? _o(t, r._storedError)
                        : (Rr(r._readableStreamController), ho(t)),
                      null
                    ),
                    (e) => (Pr(r._readableStreamController, e), _o(t, e), null),
                  ),
                  t._finishPromise
                );
              })(e);
                ...
                return (
                  ...
                  h(
                    ...
                    () => (
                      'errored' === o._state
                        ? _o(r, o._storedError)
                        : (Xt(o._writableStreamController, t), ao(e), ho(r)),
                      null
                    ),
                    (t) => (
                      Xt(o._writableStreamController, t), ao(e), _o(r, t), null
                    ),
                  ),
                  r._finishPromise
                );
            ...
            void 0 !== i.start
              ? b(i.start(this._transformStreamController))
              : b(void 0));
        }
        get readable() {
      ...
      function io(e, t) {
        (uo(e._transformStreamController),
          Xt(e._writable._writableStreamController, t),
          ao(e));
      }
      function ao(e) {
      ...
      (Object.defineProperties(TransformStreamDefaultController.prototype, {
        ...
        (e.TransformStreamDefaultController = TransformStreamDefaultController),
  ...
  var require_react_dom_server_browser_production =
    /* @__PURE__ */ __commonJSMin((exports) => {
      init_ssr();
      ...
      function createRenderState(
        ...
        var inlineScriptWithNonce =
          ...
          nonceStyle =
            'string' === typeof nonce ? void 0 : nonce && nonce.style,
        ...
        void 0 !== bootstrapScriptContent &&
          ...
          bootstrapChunks.push(
            endOfStartTag,
            stringToChunk(
              ('' + bootstrapScriptContent).replace(
                scriptRegex,
                scriptReplacer,
              ),
            ),
          ...
          for (importMap = 0; importMap < bootstrapScripts.length; importMap++)
            ((idPrefix = bootstrapScripts[importMap]),
              ...
              'string' === typeof idPrefix
                ...
                : ((inlineStyleWithNonce.href = maxHeadersLength =
                    idPrefix.src),
          ...
          for (nonce = 0; nonce < bootstrapModules.length; nonce++)
            ((nonceStyle = bootstrapModules[nonce]),
              ...
              'string' === typeof nonceStyle
                ...
                : ((inlineScriptWithNonce.href = bootstrapScripts =
                    nonceStyle.src),
      ...
      var headPreambleContributionChunk =
        stringToPrecomputedChunk('<!--head-->');
      var bodyPreambleContributionChunk =
        stringToPrecomputedChunk('<!--body-->');
      var htmlPreambleContributionChunk =
        stringToPrecomputedChunk('<!--html-->');
      function pushScriptImpl(target, props) {
        target.push(startChunkForTag('script'));
        var children = null,
          innerHTML = null,
      ...
      function pushStartInstance(
        ...
        switch (type) {
          ...
          case 'a':
            ...
            if ('string' === typeof children) {
              target$jscomp$0.push(
                stringToChunk(escapeTextForBrowser(children)),
              );
              var JSCompiler_inline_result = null;
            } else JSCompiler_inline_result = children;
            return JSCompiler_inline_result;
      ...
      var completeBoundaryWithStylesScript1FullPartial =
        stringToPrecomputedChunk(
          '$RM=new Map;$RR=function(n,w,p){function u(q){this._p=null;q()}for(var r=new Map,t=document,h,b,e=t.querySelectorAll("link[data-precedence],style[data-precedence]"),v=[],k=0;b=e[k++];)"not all"===b.getAttribute("media")?v.push(b):("LINK"===b.tagName&&$RM.set(b.getAttribute("href"),b),r.set(b.dataset.precedence,h=b));e=0;b=[];var l,a;for(k=!0;;){if(k){var f=p[e++];if(!f){k=!1;e=0;continue}var c=!1,m=0;var d=f[m++];if(a=$RM.get(d)){var g=a._p;c=!0}else{a=t.createElement("link");a.href=d;a.rel=\n"stylesheet";for(a.dataset.precedence=l=f[m++];g=f[m++];)a.setAttribute(g,f[m++]);g=a._p=new Promise(function(q,x){a.onload=u.bind(a,q);a.onerror=u.bind(a,x)});$RM.set(d,a)}d=a.getAttribute("media");!g||d&&!matchMedia(d).matches||b.push(g);if(c)continue}else{a=v[e++];if(!a)break;l=a.getAttribute("data-precedence");a.removeAttribute("media")}c=r.get(l)||h;c===h&&(h=a);r.set(l,a);c?c.parentNode.insertBefore(a,c.nextSibling):(c=t.head,c.insertBefore(a,c.firstChild))}if(p=document.getElementById(n))p.previousSibling.data=\n"$~";Promise.all(b).then($RC.bind(null,n,w),$RX.bind(null,n,"CSS failed to load"))};$RR("',
        );
      ...
      var styleTagResourceOpen1 =
        stringToPrecomputedChunk(' data-precedence="');
          ...
          if (2 !== resource.state)
            if (3 === resource.state)
              ...
              writeChunk(
                ...
                stringToChunk(
                  escapeJSObjectForInstructionScripts(
                    sanitizeURL('' + resource.props.href),
                  ),
                ),
              );
              precedence = '' + precedence;
      ...
      function flushPartiallyCompletedSegment(
        ...
        writeChunk(destination, request.placeholderPrefix);
        writeChunk(destination, segmentID);
        destination = writeChunkAndReturn(
          destination,
          completeSegmentScriptEnd,
        );
        return destination;
      }
      var flushingPartialBoundaries = !1;
            ...
            if (null !== completedRootSegment) {
              ...
              if (bodyChunks)
                for (
                  ...
                  writeChunk(
                    destination,
                    bodyChunks[completedPreambleSegments],
                  );
              flushSegment(request, destination, completedRootSegment, null);
              request.completedRootSegment = null;
              var renderState$jscomp$0 = request.renderState;
              if (
                ...
                if (0 === (resumableState$jscomp$0.instructions & 64)) {
                  ...
                  writeChunk(
                    destination,
                    renderState$jscomp$0.startInlineScript,
                  );
                  if (0 === (resumableState$jscomp$0.instructions & 32)) {
                    resumableState$jscomp$0.instructions |= 32;
                    var shellId = '_' + resumableState$jscomp$0.idPrefix + 'R_';
      ...
      function abort(request, reason) {
        ...
        try {
          ...
          (logRecoverableError(request, error$72, {}),
            fatalError(request, error$72));
        }
      }
      function addToReplayParent(node, parentKeyPath, trackedPostpones) {
        if (null === parentKeyPath) trackedPostpones.rootNodes.push(node);
      ...
      exports.resumeAndPrerender = function (
        children,
        postponedState,
        options,
      ) {
  ...
  function serverSideRendering(routeTree) {
    ...
    return {
      ...
      async renderFn(payload) {
        const stream = await (0, import_server_browser.renderToReadableStream)(
          await element(payload),
        );
  ...
  var init_DevResources = __esmMin(() => {
    ...
    DevResources = ({ devServerConfig }) => {
       ...
       */
      return /* @__PURE__ */ (0, import_jsx_runtime$9.jsxs)(
        import_jsx_runtime$9.Fragment,
        {
          children: [
  ...
  var init_ProdResources = __esmMin(() => {
    ...
    ProdResources = ({ cssBundles, jsBundles }) => {
      return /* @__PURE__ */ (0, import_jsx_runtime$8.jsxs)(
        import_jsx_runtime$8.Fragment,
        {
          children: [
            cssBundles?.map((cssHref) =>
              /* @__PURE__ */ (0, import_jsx_runtime$8.jsx)(
                'link',
                {
                  rel: 'stylesheet',
                  precedence: 'high',
  ...
  function TuonoScripts() {
    const serverPayload = useTuonoContextServerPayload();
    return /* @__PURE__ */ (0, import_jsx_runtime$7.jsxs)(
      import_jsx_runtime$7.Fragment,
      {
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime$7.jsx)('script', {
            suppressHydrationWarning: true,
            dangerouslySetInnerHTML: {
              __html: `window['${SERVER_PAYLOAD_VARIABLE_NAME}']=${escapeForScript(useTuonoContextRawServerPayload() ?? JSON.stringify(serverPayload))}`,
            },
          }),
          serverPayload.mode === 'Dev' &&
            /* @__PURE__ */ (0, import_jsx_runtime$7.jsx)(DevResources, {
              devServerConfig: serverPayload.devServerConfig,
            }),
          serverPayload.mode === 'Prod' &&
            /* @__PURE__ */ (0, import_jsx_runtime$7.jsx)(ProdResources, {
  ...
  function RootLayout({ children }) {
    return /* @__PURE__ */ (0, import_jsx_runtime$6.jsx)('html', {
      children: /* @__PURE__ */ (0, import_jsx_runtime$6.jsxs)('body', {
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime$6.jsx)('main', { children }),
          /* @__PURE__ */ (0, import_jsx_runtime$6.jsx)(TuonoScripts, {}),
        ],
      }),
    });
  }
  ...
  function IndexPage({ subtitle }) {
    return /* @__PURE__ */ (0, import_jsx_runtime$5.jsxs)(
      import_jsx_runtime$5.Fragment,
      {
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime$5.jsxs)('nav', {
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime$5.jsx)(Link, {
                href: '/second-route',
                children: 'Routing link',
              }),
              /* @__PURE__ */ (0, import_jsx_runtime$5.jsx)(Link, {
                href: '/throws',
                children: 'Throws',
  ...
  function ThrowsPage$1() {
    const [renderError, setRenderError] = (0, import_react.useState)(false);
    return /* @__PURE__ */ (0, import_jsx_runtime$4.jsxs)('div', {
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime$4.jsx)('h1', {
          children: 'Throws',
        }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime$4.jsx)('button', {
          ...
          children: 'Throw an uncaught error',
        }),
        /* @__PURE__ */ (0, import_jsx_runtime$4.jsx)('button', {
          type: 'button',
          ...
          onClick: () => {
            Promise.reject(
              /* @__PURE__ */ new Error('Unhandled promise rejection'),
            );
          },
          children: 'Reject a promise',
        }),
        renderError && /* @__PURE__ */ (0, import_jsx_runtime$4.jsx)(Bomb, {}),
      ],
    });
  }
  var import_react, import_jsx_runtime$4;
  var init_page$4 = __esmMin(() => {
    import_react = /* @__PURE__ */ __toESM(require_react(), 1);
    import_jsx_runtime$4 = require_jsx_runtime();
  });
  //#endregion
  //#region src/routes/second-route/page.tsx
  var page_exports$3 = /* @__PURE__ */ __exportAll({
    default: () => SecondRoute,
  });
  function SecondRoute() {
    return /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)('h1', {
      children: 'Second route',
    });
  }
  var import_jsx_runtime$3;
  var init_page$3 = __esmMin(() => {
    import_jsx_runtime$3 = require_jsx_runtime();
  });
  //#endregion
  //#region src/routes/rust-error/page.tsx
  var page_exports$2 = /* @__PURE__ */ __exportAll({
    default: () => RustErrorPage$1,
  });
  /**
   ...
   */
  function RustErrorPage$1() {
    return /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)('h1', {
      children: 'Rust error route',
    });
  }
  var import_jsx_runtime$2;
  var init_page$2 = __esmMin(() => {
  ...
  function PokemonPage({ name }) {
    return /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)('h1', {
  ...
  //#endregion
  //#region src/routes/docs/[...slug]/page.tsx
  var page_exports = /* @__PURE__ */ __exportAll({ default: () => DocPage });
  ...
  init_esm();
  var PageImport = RouteLazyLoading(() =>
    Promise.resolve().then(() => (init_page$5(), page_exports$5)),
  );
  var ThrowsPageImport = RouteLazyLoading(() =>
    Promise.resolve().then(() => (init_page$4(), page_exports$4)),
  );
  var SecondRoutePageImport = RouteLazyLoading(() =>
    Promise.resolve().then(() => (init_page$3(), page_exports$3)),
  );
  var RustErrorPageImport = RouteLazyLoading(() =>
    Promise.resolve().then(() => (init_page$2(), page_exports$2)),
  );
  var PokemonspokemonPageImport = RouteLazyLoading(() =>
    Promise.resolve().then(() => (init_page$1(), page_exports$1)),
  );
  var DocsslugPageImport = RouteLazyLoading(() =>
    Promise.resolve().then(() => (init_page(), page_exports)),
  );
  ...
  var ThrowsPage = createRoute({ component: ThrowsPageImport });
  var SecondRoutePage = createRoute({ component: SecondRoutePageImport });
  var RustErrorPage = createRoute({ component: RustErrorPageImport });
  var PokemonspokemonPage = createRoute({
    component: PokemonspokemonPageImport,
  });
  var DocsslugPage = createRoute({ component: DocsslugPageImport });
  ...
  var ThrowsPageRoute = ThrowsPage.update({
    path: '/throws',
    getParentRoute: () => rootRoute,
    filePath: '/throws/',
    dataKey: '/throws/page',
  });
  var SecondRoutePageRoute = SecondRoutePage.update({
    path: '/second-route',
    getParentRoute: () => rootRoute,
    filePath: '/second-route/',
    dataKey: '/second-route/page',
  });
  var RustErrorPageRoute = RustErrorPage.update({
    path: '/rust-error',
    getParentRoute: () => rootRoute,
    hasHandler: true,
    filePath: '/rust-error/',
    dataKey: '/rust-error/page',
  });
  ...
  var DocsslugPageRoute = DocsslugPage.update({
    path: '/docs/[...slug]',
    getParentRoute: () => rootRoute,
    hasHandler: true,
    filePath: '/docs/[...slug]/',
    dataKey: '/docs/[...slug]/page',
  });
  var routeTree = rootRoute.addChildren([
    PageRoute,
    RustErrorPageRoute,
    SecondRoutePageRoute,
    ThrowsPageRoute,
    DocsslugPageRoute,
