...
// The index page renders through tuono's streaming SSR path (`finish_render` →
// `render_pool::render_stream`). Unlike the tuono_lib unit test — which uses a
// hand-written stub bundle — this runs against a real `tuono` build, so it is
