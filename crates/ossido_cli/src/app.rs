...
impl App {
    ...
    /// declare no `#[static_paths]` enumerator. Empty means `ossido build
        ...
        for port in ports {
            if !port_is_available(&config.server.host, port) {
                log::backend(
                    Level::Error,
                    format!(
                        "Port {port} is already in use. Stop the process using it, or set a different `server.port` in ossido.config.ts."
                    ),
                );
                std::process::exit(1);
            }
    ...
    pub fn build_ossido_config(&mut self) -> io::Result<std::process::Output> {
        if !Path::new(BUILD_OSSIDO_CONFIG).exists() {
...
mod tests {
    ...
    fn should_collect_routes() {
        let mut app = App::new();
        #[cfg(target_os = "windows")]
        let base_path = "\\home\\user\\Documents\\ossido";
        ...
        let routes = [
            ...
            "\\home\\user\\Documents\\ossido\\src\\routes\\page.rs",
            "\\home\\user\\Documents\\ossido\\src\\routes\\posts\\page.rs",
            "\\home\\user\\Documents\\ossido\\src\\routes\\posts\\[post]\\page.rs",
            "\\home\\user\\Documents\\ossido\\src\\routes\\posts\\handle-this\\page.rs",
            "\\home\\user\\Documents\\ossido\\src\\routes\\posts\\handle-this\\[post]\\page.rs",
            "\\home\\user\\Documents\\ossido\\src\\routes\\posts\\UPPERCASE\\page.rs",
        ];
    ...
    fn should_create_multi_level_axum_paths() {
        ...
        let routes = [
            ...
            "\\home\\user\\Documents\\ossido\\src\\routes\\page.rs",
            "\\home\\user\\Documents\\ossido\\src\\routes\\posts\\page.rs",
            "\\home\\user\\Documents\\ossido\\src\\routes\\posts\\any-post\\page.rs",
            "\\home\\user\\Documents\\ossido\\src\\routes\\posts\\[post]\\page.rs",
        ];
    ...
    fn should_ignore_whitelisted_extensions() {
        let mut app = App::new();
        app.base_path = "/home/user/Documents/ossido".into();

        let routes = [
            "/home/user/Documents/ossido/src/routes/about.css",
            "/home/user/Documents/ossido/src/routes/index.scss",
            "/home/user/Documents/ossido/src/routes/posts/index.sass",
        ];
    ...
    fn should_ignore_special_and_stray_files() {
        ...
        let routes = [
            "/home/user/Documents/ossido/src/routes/layout.tsx",
            "/home/user/Documents/ossido/src/routes/posts/layout.tsx",
            "/home/user/Documents/ossido/src/routes/loading.tsx",
            "/home/user/Documents/ossido/src/routes/error.tsx",
            "/home/user/Documents/ossido/src/routes/not-found.tsx",
            "/home/user/Documents/ossido/src/routes/posts/loading.tsx",
            // A stray colocated component is not a route.
            "/home/user/Documents/ossido/src/routes/posts/helper.tsx",
        ];
    ...
    fn should_collect_only_page_and_api_files() {
        ...
        let page = "/home/user/Documents/ossido/src/routes/about/page.rs";
        let layout_handler = "/home/user/Documents/ossido/src/routes/about/layout.rs";
        let stray = "/home/user/Documents/ossido/src/routes/about/helper.tsx";
        let layout_component = "/home/user/Documents/ossido/src/routes/about/layout.tsx";
        ...
        assert!(is_api_path(
            Path::new("/home/user/Documents/ossido/src/routes/api/health_check.rs"),
            &app.base_path
        ));
    }
    ...
    fn should_correctly_parse_routes_with_server_handler() {
        ...
        let routes = [
            "\\home\\user\\Documents\\ossido\\src\\routes\\about\\page.rs",
            "\\home\\user\\Documents/ossido\\src\\routes\\about\\page.tsx",
            "\\home\\user\\Documents\\ossido\\src\\routes\\page.tsx",
        ];
    ...
    fn dynamic_routes_without_static_paths_lists_the_dynamic_ones() {
        ...
        app2.base_path = "/home/user/Documents/ossido".into();

        let routes = [
            "/home/user/Documents/ossido/src/routes/[post]/page.rs",
            "/home/user/Documents/ossido/src/routes/posts/[post]/page.rs",
        ];
        routes
            .into_iter()
