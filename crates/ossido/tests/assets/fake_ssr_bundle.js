...
// bundle contract that `ossido_ssr` + `crate::ssr::Js` depend on, so the tests can
...
//
// The contract: an ES module (compiled by `ossido_ssr`'s `from_module`) exposing two
...
// payload). Both exports are synchronous — `ossido_ssr` handles a plain return the
