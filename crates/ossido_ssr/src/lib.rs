#![doc(html_logo_url = "https://raw.githubusercontent.com/ossido-labs/ossido/main/logo.png")]
...
//!
//! ℹ️ **This project is the backbone of [tuono](https://github.com/ossido-labs/ossido); a fullstack react framework with built in SSR.**
//!
//! Currently it works with [Vite](https://vitejs.dev/), [Webpack](https://webpack.js.org/), [Rspack](https://www.rspack.dev/), [React 18](https://react.dev/), [Svelte 5](https://svelte.dev/) and [SolidJS](https://solidjs.com/) - Check the <a href="https://github.com/ossido-labs/ossido/blob/main/examples" target="_blank">examples</a> folder.
//!
//! > Check <a href="https://github.com/ossido-labs/ossido/blob/main/benches">here</a> the
//! > benchmarks results.
//!
//!  # Getting started
//! ```bash
//! cargo add ossido_ssr
//! ```
//!
//!  # Example
//!
...
//!
//! > Examples with different web frameworks are available in the <a href="https://github.com/ossido-labs/ossido/blob/main/examples" target="_blank">examples</a> folder.
//!
